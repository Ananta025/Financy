  ...
  return (
    <div id='about-hero' className='container'>
      ...
      <div id='about-hero-para' className="row">
        <div className="col-lg-6 col-md-12 p-lg-4 p-md-4 p-3">
        ...
        <div className="col-lg-6 col-md-12 p-lg-4 p-md-4 p-3 mt-md-0 mt-3">
          <p>
      ...
      <div className='row mb-5 mt-3'>
        <h2 className='text-center py-4 mb-5'>Devloped By</h2>
        <div className="col-lg-6 col-md-12 text-center mb-4 mb-lg-0">
          <div className="rounded-circle overflow-hidden mx-auto" style={{width: "18rem", height: "18rem", maxWidth: "100%"}}>
        ...
        <div id="developer-info" className="col-lg-6 col-md-12 px-lg-4 px-md-4 px-3">
          <p>
