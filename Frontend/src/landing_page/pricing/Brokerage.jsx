    ...
    <div id='brokerage' className='container'>
        <div className="row gap-md-5 mb-4">
            ...
            <div className="col-12 col-lg-5 text-muted mb-4 mb-lg-0">
                ...
                <p>BSE has revised transaction charges in XC, XD, XT, Z and ZP groups to ₹10,000 per crore w.e.f 01.01.2016. (XC and XD groups have been merged into a new group X w.e.f 01.12.2017) BSE has revised transaction charges in SS and ST groups to ₹1,00,000 per crore of gross turnover.</p>
            ...
            <div className="col-12 col-lg-5 text-muted">
                ...
                <p>For BSDA demat account: Zero charges if the holding value is less than ₹4,00,000. To learn more about BSDA, <span>Click here</span> </p>
                <p>For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly (90 days). To learn more about AMC, <span> Click here</span></p>
                ...
                <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. <span> Learn more</span>.</p>
